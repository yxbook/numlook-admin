          ...
          options: [
            {
              ...
              series: [
                ...
                {data: [
                    {name: '日志', value: dataMap.dataPI['2002sum']},
                    {name: '异常', value: dataMap.dataSI['2002sum']},
                    {name: '事物', value: dataMap.dataTI['2002sum']}
                  ]}
              ]
            },
            {
              ...
              series : [
                ...
                {data: [
                    {name: '日志', value: dataMap.dataPI['2003sum']},
                    {name: '异常', value: dataMap.dataSI['2003sum']},
                    {name: '事物', value: dataMap.dataTI['2003sum']}
                  ]}
              ]
            },
            {
              ...
              series : [
                ...
                {data: [
                    {name: '日志', value: dataMap.dataPI['2004sum']},
                    {name: '异常', value: dataMap.dataSI['2004sum']},
                    {name: '事物', value: dataMap.dataTI['2004sum']}
                  ]}
              ]
            },
            {
              ...
              series : [
                ...
                {data: [
                    {name: '日志', value: dataMap.dataPI['2005sum']},
                    {name: '异常', value: dataMap.dataSI['2005sum']},
                    {name: '事物', value: dataMap.dataTI['2005sum']}
                  ]}
              ]
            },
            {
              ...
              series : [
                ...
                {data: [
                    {name: '日志', value: dataMap.dataPI['2006sum']},
                    {name: '异常', value: dataMap.dataSI['2006sum']},
                    {name: '事物', value: dataMap.dataTI['2006sum']}
                  ]}
              ]
            },
            {
              ...
              series : [
                ...
                {data: [
                    {name: '日志', value: dataMap.dataPI['2007sum']},
                    {name: '异常', value: dataMap.dataSI['2007sum']},
                    {name: '事物', value: dataMap.dataTI['2007sum']}
                  ]}
              ]
            },
            {
              ...
              series : [
                ...
                {data: [
                    {name: '日志', value: dataMap.dataPI['2008sum']},
                    {name: '异常', value: dataMap.dataSI['2008sum']},
                    {name: '事物', value: dataMap.dataTI['2008sum']}
                  ]}
              ]
            },
            {
              ...
              series : [
                ...
                {data: [
                    {name: '日志', value: dataMap.dataPI['2009sum']},
                    {name: '异常', value: dataMap.dataSI['2009sum']},
                    {name: '事物', value: dataMap.dataTI['2009sum']}
                  ]}
              ]
            },
            {
              ...
              series : [
                ...
                {data: [
                    {name: '日志', value: dataMap.dataPI['2010sum']},
                    {name: '异常', value: dataMap.dataSI['2010sum']},
                    {name: '事物', value: dataMap.dataTI['2010sum']}
                  ]}
              ]
            },
            {
              ...
              series : [
                ...
                {data: [
                    {name: '日志', value: dataMap.dataPI['2011sum']},
                    {name: '异常', value: dataMap.dataSI['2011sum']},
                    {name: '事物', value: dataMap.dataTI['2011sum']}
                  ]}
              ]
            }
          ]
